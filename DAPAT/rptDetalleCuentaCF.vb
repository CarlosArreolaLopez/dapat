...
Public Class rptDetalleCuentaCF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DAPAT.rptDetalleCuentaCF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalleCuentaCF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalleCuentaCF = New rptDetalleCuentaCF()
        rpt.Site = Me.Site
        Return rpt
    End Function
